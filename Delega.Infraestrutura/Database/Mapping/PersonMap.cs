...
public class PersonMap : IEntityTypeConfiguration<Person>
{
    public void Configure(EntityTypeBuilder<Person> builder)
    {
        ...
        builder.Property(x => x.FirstName).IsRequired().HasMaxLength(90).HasColumnName("first_name");
        builder.Property(x => x.LastName).IsRequired().HasMaxLength(90).HasColumnName("last_name");
    }
}
