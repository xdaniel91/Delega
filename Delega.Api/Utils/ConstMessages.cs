...
public class ConstMessages : IConstMessages
{
    ...
    public Dictionary<string, string> GetMessages(string idioma = "pt-br")
    {
        var idiomaLower = idioma.ToLower();

        var result = idiomaLower switch
        {
            "en-us" => ConstMessagesSysId.MessagesEnglish(),
            "es-es" => ConstMessagesSysId.MessagesSpanish(),
            _ => ConstMessagesSysId.MessagesPortugues()
        };
...
public static class ConstMessagesSysId
{
    #region Person
